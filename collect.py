...
def demo_output(now):
    interfaces = [
        {"name": "ether1", "type": "ether", "kind": "ethernet", "running": True, "disabled": False, "slave": False, "comment": "ISP", "mac": "DC:2C:6E:00:00:01", "mtu": 1500,
        ...
        {"name": "bridge", "type": "bridge", "kind": "bridge", "running": True, "disabled": False, "slave": False, "comment": "defconf", "mac": "DC:2C:6E:00:00:02", "mtu": 1500,
        ...
        {"name": "ether3", "type": "ether", "kind": "ethernet", "running": True, "disabled": False, "slave": True, "comment": "", "mac": "DC:2C:6E:00:00:03", "mtu": 1500,
        ...
        {"name": "wifi1", "type": "wifi", "kind": "wifi", "running": True, "disabled": False, "slave": True, "comment": "", "mac": "DC:2C:6E:00:00:0C", "mtu": 1500,
        ...
        {"name": "wifi2", "type": "wifi", "kind": "wifi", "running": True, "disabled": False, "slave": True, "comment": "", "mac": "DC:2C:6E:00:00:0D", "mtu": 1500,
        ...
        {"name": "zerotier1", "type": "zerotier", "kind": "zerotier", "running": True, "disabled": False, "slave": False, "comment": "", "mac": "3A:13:7B:00:00:4F", "mtu": 2800,
    ...
    wan = {"present": True, "up": True, "iface": "pppoe-out1", "kind": "pppoe", "gateway": "pppoe-out1", "ip": "203.0.113.42/32", "sinceUp": "2026-05-20 09:36:29", "detail": "", "pppoeUser": "isp-user", "pppoeOn": "ether1", "acName": "BRAS-01", "linkDowns": 0}
    clients = [
        {"ip": "192.168.88.194", "mac": "B8:27:EB:A1:6C:C3", "host": "SteelNodePi1", "comment": "", "status": "bound", "dynamic": False, "static": True, "server": "defconf", "expires": 1094, "lastSeen": 706, "blocked": False, "wifi": False, "firstSeen": 0},
        {"ip": "192.168.88.193", "mac": "B8:27:EB:6F:6C:C7", "host": "SteelNodePi2", "comment": "", "status": "bound", "dynamic": False, "static": True, "server": "defconf", "expires": 1000, "lastSeen": 60, "blocked": False, "wifi": False, "firstSeen": 0},
        {"ip": "192.168.88.180", "mac": "BC:24:11:F2:09:49", "host": "openclaw1", "comment": "proxmox VM", "status": "bound", "dynamic": False, "static": True, "server": "defconf", "expires": 900, "lastSeen": 12, "blocked": False, "wifi": False, "firstSeen": 0},
        {"ip": "192.168.88.151", "mac": "2C:98:11:7B:2B:83", "host": "omarchy", "comment": "", "status": "bound", "dynamic": True, "static": False, "server": "defconf", "expires": 1500, "lastSeen": 3, "blocked": False, "wifi": True, "firstSeen": 0},
        {"ip": "192.168.88.168", "mac": "7E:64:8F:2C:4F:53", "host": "POCO-X7-Pro", "comment": "", "status": "bound", "dynamic": True, "static": False, "server": "defconf", "expires": 1700, "lastSeen": 15, "blocked": False, "wifi": True, "firstSeen": 0},
        {"ip": "192.168.88.156", "mac": "26:04:88:2C:C9:4D", "host": "iPhone", "comment": "", "status": "bound", "dynamic": True, "static": False, "server": "defconf", "expires": 1600, "lastSeen": 3, "blocked": False, "wifi": True, "firstSeen": 0},
        {"ip": "192.168.88.171", "mac": "F0:9E:4A:11:22:33", "host": "unknown-android", "comment": "", "status": "bound", "dynamic": True, "static": False, "server": "defconf", "expires": 1790, "lastSeen": 1, "blocked": False, "wifi": True, "firstSeen": now - 420},
    ]
    wifi_clients = [
        {"mac": "2C:98:11:7B:2B:83", "iface": "wifi2", "ssid": "SteelGreen-5", "band": "5ghz-ac", "signal": -40, "uptime": 10378, "lastActivity": 0, "rxRate": 866000000, "txRate": 866000000, "rxBps": 2746, "txBps": 18408, "rxBytes": 857205992, "txBytes": 674992607, "auth": "wpa2-psk", "host": "omarchy", "ip": "192.168.88.151"},
        {"mac": "7E:64:8F:2C:4F:53", "iface": "wifi2", "ssid": "SteelGreen-5", "band": "5ghz-ac", "signal": -51, "uptime": 11453, "lastActivity": 15, "rxRate": 866000000, "txRate": 780000000, "rxBps": 120, "txBps": 400, "rxBytes": 12345678, "txBytes": 87654321, "auth": "wpa2-psk", "host": "POCO-X7-Pro", "ip": "192.168.88.168"},
        {"mac": "26:04:88:2C:C9:4D", "iface": "wifi1", "ssid": "SteelGreen-2", "band": "2ghz-n", "signal": -71, "uptime": 11397, "lastActivity": 3, "rxRate": 72200000, "txRate": 65000000, "rxBps": 0, "txBps": 0, "rxBytes": 2345678, "txBytes": 7654321, "auth": "wpa2-psk", "host": "iPhone", "ip": "192.168.88.156"},
        {"mac": "F0:9E:4A:11:22:33", "iface": "wifi1", "ssid": "SteelGreen-2", "band": "2ghz-n", "signal": -78, "uptime": 420, "lastActivity": 1, "rxRate": 65000000, "txRate": 58500000, "rxBps": 900, "txBps": 300, "rxBytes": 45678, "txBytes": 54321, "auth": "wpa2-psk", "host": "unknown-android", "ip": "192.168.88.171"},
    ]
    return {
        "ts": now, "tookMs": 63, "demo": True, "version": VERSION,
        "router": {"identity": "MikroTik", "board": "hAP ac^3", "model": "RBD53iG-5HacD2HnD", "version": "7.21.3 (stable)", "channel": "stable", "firmware": "6.47.10", "firmwareUpgrade": "7.21.3",
                   ...
                   "hddFree": 92_352_512, "hddTotal": 134_217_728, "badBlocks": 0, "serial": "F34E0F220000", "arch": "arm", "time": "13:32:11", "date": "2026-09-14", "tz": "Europe/Warsaw"},
        ...
        "wifi": {"radios": [
            {"name": "wifi1", "ssid": "SteelGreen-2", "mode": "ap", "freq": 2412, "width": "20mhz", "master": True, "masterOf": "", "running": True, "disabled": False, "clients": 2},
            {"name": "wifi2", "ssid": "SteelGreen-5", "mode": "ap", "freq": 5180, "width": "20/40/80mhz", "master": True, "masterOf": "", "running": True, "disabled": False, "clients": 2},
            {"name": "wifi3", "ssid": "SteelGreen-IoT", "mode": "ap", "freq": 0, "width": "", "master": False, "masterOf": "wifi1", "running": False, "disabled": False, "clients": 0},
        ], "clients": wifi_clients},
        "clients": clients, "clientsBound": 7,
        "zerotier": {"instances": [{"name": "zt1", "online": True, "state": "running", "address": "ad67080a2a", "port": 9993, "disabled": False}],
        ...
        "log": [{"time": "2026-09-14 13:05:43", "topics": "dhcp,info", "message": "defconf assigned 192.168.88.171 for F0:9E:4A:11:22:33 unknown-android", "level": "info"},
                {"time": "2026-09-14 13:07:51", "topics": "wireless,info", "message": "F0:9E:4A:11:22:33@wifi1(SteelGreen-2) connected, signal strength -78", "level": "info"},
        ...
        "alerts": [{"id": "client:1", "kind": "client", "at": now - 420, "urgent": False, "title": "New device on the network", "body": "unknown-android (192.168.88.171) on SteelGreen-2", "macs": ["F0:9E:4A:11:22:33"]},
